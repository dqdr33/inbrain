...
- Ship hybrid search in Inbrain v0.3. This is the highest priority feature.
...
- [ ] Implement pgvector extension and embedding storage in Inbrain schema
- [ ] Build hybrid search with RRF scoring in Inbrain v0.3
...
Productive sync. The Inbrain search discussion was the most substantive — we identified
