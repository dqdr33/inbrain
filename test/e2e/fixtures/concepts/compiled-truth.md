...
The two-layer page pattern used throughout Inbrain. Every page has two distinct
...
Inbrain uses retrieval-augmented generation (RAG) to surface relevant pages during
...
Extended the pattern to all Inbrain page types: people, companies, deals, meetings,
