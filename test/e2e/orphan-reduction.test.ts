 ...
 *   2. Cross-check: inbrain orphans --count and doctor JSON orphan_ratio
...
describe('v0.42.0.0 e2e — orphan reduction via --by-mention', () => {
  ...
  test('2. cross-check — inbrain orphans count matches doctor JSON orphan_ratio numerator', async () => {
    ...
    // CLI `inbrain orphans --count` output.
    captureCli();
