/**
 * E2E for `inbrain eval cross-modal` runner via mocked gateway chat().
 *
...
beforeEach(() => {
  tempDir = mkdtempSync(join(tmpdir(), 'inbrain-cme-e2e-'));
...
describe('inbrain eval cross-modal — runner verdict contract', () => {
