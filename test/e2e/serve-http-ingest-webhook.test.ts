 ...
 * source registered inside `inbrain serve --http` per the plan-eng-review E1
 ...
 *
 * Spawns a real `inbrain serve --http` against real Postgres, mints OAuth
 ...
 *
 * Run: INBRAIN_DATABASE_URL=... bun test test/e2e/serve-http-ingest-webhook.test.ts
 */
