/**
 * Tests for env-aware `inbrain autopilot --install`.
 *
 * Covers:
...
beforeEach(() => {
  ...
  tmp = mkdtempSync(join(tmpdir(), 'inbrain-install-test-'));
...
// exported INBRAIN_DATABASE_URL or {OPENAI,ANTHROPIC}_API_KEY in zshrc and
