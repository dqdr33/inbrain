 ...
 * framing ("Search gives you raw pages. Inbrain gives you the answer.")
...
describe('README hero anchors (D9 regression guard)', () => {
  ...
  test('leads with the search-vs-answer differentiator (v0.40.8.1+)', () => {
    // The post-rewrite headline. "Search gives you raw pages. Inbrain gives
    // you the answer." is the load-bearing framing that distinguishes
    // Inbrain from MemPalace-shape retrieval tools. If a cleanup PR
    // accidentally rewords this, the brand-level differentiator is lost.
    expect(hero).toMatch(/Search gives you raw pages\. Inbrain gives you the answer/);
  });
