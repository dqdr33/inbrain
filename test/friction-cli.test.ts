...
describe('log subcommand', () => {
  test('writes a friction entry under INBRAIN_HOME', () => {
...
describe('INBRAIN_FRICTION_RUN_ID fallback (D19)', () => {
  ...
  test('log honors $INBRAIN_FRICTION_RUN_ID', () => {
    process.env.INBRAIN_FRICTION_RUN_ID = 'env-run';
    try {
