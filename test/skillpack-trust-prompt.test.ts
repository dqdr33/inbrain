...
function makeInput(
  ...
  return {
    ...
    resolved: {
      path: '/tmp/cached/inbrain-ai/skillpack-hackathon-evaluation/abc123',
      kind: 'git',
      source: 'https://github.com/inbrain-ai/skillpack-hackathon-evaluation.git',
...
describe('renderIdentityBlock — pure formatter', () => {
  test('renders the canonical identity block for a git source', () => {
    ...
    expect(block).toContain('Author:        Inbrain Team');
    expect(block).toContain('Source:        https://github.com/inbrain-ai/skillpack-hackathon-evaluation.git');
