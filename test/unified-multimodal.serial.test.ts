...
//   - reindex --multimodal cost estimate + dry-run + INBRAIN_NO_REEMBED bypass
...
describe('reindex --multimodal command (Phase 3)', () => {
  ...
  test('INBRAIN_NO_REEMBED=1 honored on zero-pending brain (skip path is no-op-clean)', async () => {
    await withEnv({ INBRAIN_NO_REEMBED: '1' }, async () => {
