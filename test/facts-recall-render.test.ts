/**
 * v0.31 Phase 6 — `inbrain recall --today` markdown render shape.
 *
...
describe('inbrain recall --as-context', () => {
  test('emits markdown comment-wrapped block', async () => {
    ...
    expect(captured.startsWith('<!-- inbrain hot memory') || captured.includes('inbrain hot memory')).toBe(true);
  });
});
