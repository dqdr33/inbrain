 ...
 * plan). Generalized to drive any CLI binary (inbrain, openclaw, claude)
 ...
 *
 * What inbrain uses this for in v0.25.1:
 *   - test/e2e/skill-smoke-openclaw.test.ts: drive an openclaw session
 *     interactively after `inbrain skillpack install book-mirror`,
 ...
 * to find `claude`, `openclaw`, `inbrain`, etc. without forcing tests
 * to hard-code paths.
 */
