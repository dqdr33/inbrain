...
//
// Pins the contract that expertTypesFromPack(inbrain-base) returns the
...
describe('expertTypesFromPack (T_W) — inbrain-base parity', () => {
  test('inbrain-base returns [person, company]', () => {
