/**
 * Tests for `inbrain extract --source db` (v0.10.3 graph layer).
 *
 * Verifies the DB-source path of the unified `inbrain extract <subcommand>`
...
describe('inbrain extract links --source db', () => {
...
describe('inbrain extract timeline --source db', () => {
  beforeEach(truncateAll);
...
describe('inbrain extract all --source db', () => {
  beforeEach(truncateAll);
