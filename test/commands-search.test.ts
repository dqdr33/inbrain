/**
 * v0.32.3 — `inbrain search modes/stats/tune` CLI tests.
 *
...
describe('inbrain search modes (read-only dashboard)', () => {
...
describe('inbrain search modes --reset', () => {
...
describe('inbrain search tune (recommendations)', () => {
...
describe('inbrain search dispatch', () => {
