 ...
 *
 * Per the locked DX spec: every inbrain-shipped skillpack must score 10/10.
 * If this test ever fails, inbrain is shipping below the bar it demands of
    ...
    if (r.score !== 10) {
      ...
      throw new Error(
        `Reference pack regressed below 10/10. Failing dimensions:\n  ${failed.join('\n  ')}\n\n` +
          `This is the bar inbrain demands of third-party publishers. Fix the reference pack, do not lower the rubric.`,
      );
    }
