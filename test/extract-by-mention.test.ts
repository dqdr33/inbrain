/**
 * Integration tests for `inbrain extract links --by-mention`.
 *
...
describe('inbrain extract links --by-mention — integration', () => {
  ...
  test('7. --source fs --by-mention rejected with paste-ready fix-hint', async () => {
    ...
    expect(stderrText).toContain('inbrain extract links --by-mention --source db');
  });
