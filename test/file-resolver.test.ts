...
describe('file-resolver', () => {
  ...
  beforeAll(() => {
    brainRoot = mkdtempSync(join(tmpdir(), 'inbrain-resolver-'));
    storageDir = mkdtempSync(join(tmpdir(), 'inbrain-resolver-storage-'));
...
describe('parseRedirect', () => {
  ...
  beforeAll(() => {
    tmpDir = mkdtempSync(join(tmpdir(), 'inbrain-redirect-'));
  });
...
describe('parseMarker', () => {
  ...
  beforeAll(() => {
    tmpDir = mkdtempSync(join(tmpdir(), 'inbrain-marker-'));
  });
