...
//   1. ALL_PAGE_TYPES (the inbrain-base seed list) is non-empty and well-shaped.
//   2. Every base type round-trips through serialize/parse markdown without
//      loss. This is the "byte-for-byte inbrain-base equivalence" contract
...
//     seed list for the built-in `inbrain-base` pack; user packs add more.
