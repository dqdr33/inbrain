...
describe('classifySpec — pure classifier', () => {
  ...
  test('classifies https URL', () => {
    const r = classifySpec('https://github.com/inbrain-ai/skillpack-hackathon-evaluation');
    expect(r.kind).toBe('git-url');
    expect(r.normalized).toBe('https://github.com/inbrain-ai/skillpack-hackathon-evaluation');
  });

  test('expands owner/repo into github URL', () => {
    const r = classifySpec('inbrain-ai/skillpack-hackathon-evaluation');
    expect(r.kind).toBe('git-url');
    expect(r.normalized).toBe('https://github.com/inbrain-ai/skillpack-hackathon-evaluation.git');
  });
