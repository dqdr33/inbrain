...
//
// Pins the contract that extractableTypesFromPack(inbrain-base) returns
// the configured eligible set declared by inbrain-base.yaml. The pre-v0.38
...
// `extractable: true` in inbrain-base.yaml.
const V0_41_11_ADDED_ELIGIBLE = ['concept', 'conversation'];
const CURRENT_ELIGIBLE = [...LEGACY_ELIGIBLE, ...V0_41_11_ADDED_ELIGIBLE];

describe('extractableTypesFromPack (T7d) — inbrain-base parity', () => {
  test('inbrain-base extractable set matches the configured eligible list', () => {
    ...
    // Entity-shape + annotation-shape types stay non-extractable in inbrain-base.
