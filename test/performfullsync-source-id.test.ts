 ...
 *   - Result: `inbrain sync --source X --full` updated `sources.last_sync_at` to look
 ...
 *     PR #707's design intent of `inbrain import` being default-only).
 ...
 * `~/atlas/agents/terminal/docs/atlas-needs-from-inbrain-spec-v2.1-2026-05-08.md`
...
describe('performFullSync threads sourceId end-to-end', () => {
  ...
  beforeEach(async () => {
    ...
    repoPath = mkdtempSync(join(tmpdir(), 'inbrain-pfs-'));
