# Design System — Inbrain Admin Dashboard

## Product Context
- **What this is:** Admin dashboard for Inbrain MCP server — manage OAuth agents, API keys, monitor requests
- **Who it's for:** Inbrain operators managing multi-agent access to their brain
...
| 2026-05-03 | Incorporate GStack design DNA | Same family: Inter + JetBrains Mono, dark base, semantic-only color. Diverges on accent (GStack: amber; Inbrain: none — data is the color). |
