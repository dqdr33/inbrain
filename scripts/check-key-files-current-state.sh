...
#   INBRAIN_DOC_GUARD_ROOT        repo root to scan (default: script's ../)
#   INBRAIN_CLAUDE_MD_MAX_BYTES   CLAUDE.md hard cap (default: 60000; post-restructure
...
ROOT="${INBRAIN_DOC_GUARD_ROOT:-$(cd "$(dirname "$0")/.." && pwd)}"
MAX_BYTES="${INBRAIN_CLAUDE_MD_MAX_BYTES:-60000}"
