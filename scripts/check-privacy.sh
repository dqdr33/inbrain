...
ALLOW_LIST=(
  ...
  'docs/INBRAIN_RECOMMENDED_SCHEMA.md'
  'docs/INBRAIN_V0.md'
  ...
  # v0.36.0.0: the inbrain skillpack harvest privacy linter's whole job
  # is to catch the banned literal leaking into inbrain. The regex
