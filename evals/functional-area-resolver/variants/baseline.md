...
- Brain search/query, hybrid search, entity lookup; Brain maintenance, lint, backlinks, health checks → `inbrain`
...
- Upgrade inbrain, update inbrain, inbrain version → `inbrain-upgrade`
...
- Inbrain PR/issue management (cron); Inbrain update, version check, stale inbrain → `inbrain`
- Inbrain search quality benchmarking → `benchmark-inbrain`
...
- inbrain PR content, anonymization, PR body for inbrain → `inbrain-pr`
...
- "Submit a shell job" → `inbrain skills/minion-orchestrator`
...
- "skillpackify", PR to inbrain, open source this skill, add to skillpack → `skillpackify`
