...
The design system source of truth for inbrain. Born from the de facto tokens
...
Inbrain talks like a smart friend who knows your past, not a clinical scoring
...
When adding a new UI surface to inbrain:
