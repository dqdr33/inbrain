/**
 * OpenClaw plugin entry point for inbrain-context engine.
 *
 ...
 *   plugins.slots.contextEngine: "inbrain-context"
 *
 * @module
 */

/**
 * OpenClaw plugin entry — registers inbrain-context engine.
 *
...
import { createInbrainContextEngine, ENGINE_ID } from './core/context-engine.ts';
...
const entry: PluginEntry = {
  id: 'inbrain-context-engine',
  name: 'Inbrain Context Engine',
