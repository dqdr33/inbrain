 ...
 *
 * Supports both 3-segment (`0.41.38`) and 4-segment (`0.42.3.0`) inbrain
 * version strings. The 4th `.MICRO` segment is inbrain's dot-suffix
 ...
 * Accepts both 3-segment (`0.41.38`) and 4-segment (`0.42.3.0`) inbrain versions. */
 ...
 * bumps are deliberately ignored, matching `inbrain check-update`'s
