 ...
 * expires. Pre-v0.41.6.0, `inbrain sync --full | head -20` would SIGPIPE
 * inbrain, finally blocks wouldn't run, and the next sync would report
 ...
 *    unhandledRejection. **NOT SIGINT** — inbrain has an existing
...
export function installSignalHandlers(): void {
  ...
  // EPIPE on stdout — the canonical `inbrain sync | head -N` case. Route
