 ...
 *
 * Consumed by both:
 *   - `inbrain doctor --remediation-plan` / `--remediate` (queue-based execution)
 *   - `inbrain features --auto-fix` (inline execution preserved per D15)
 *
 ...
 * `inbrain doctor --remediation-plan` — the planner would just ignore it.
 *
