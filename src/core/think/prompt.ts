/**
 * v0.28: system prompt + structured-output schema for `inbrain think`.
 *
...
export const THINK_SYSTEM_PROMPT_BASE = `You are inbrain's synthesis engine. You answer questions by reasoning across the user's personal knowledge brain. Your inputs are wrapped in structural tags:
