/**
 * Inbrain Context Engine for OpenClaw
 *
...
export const ENGINE_ID = 'inbrain-context';
export const ENGINE_NAME = 'Inbrain Context Engine';
/**
...
function formatContextBlock(ctx: LiveContext): string {
  const lines: string[] = [
    `## Live Context (deterministic, injected by inbrain-context engine)`,
  ];
...
export function createInbrainContextEngine(ctx: {
  workspaceDir?: string;
}): ContextEngine {
