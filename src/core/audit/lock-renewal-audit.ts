 ...
 *
 * File: `~/.inbrain/audit/lock-renewal-YYYY-Www.jsonl` (ISO-week
 * rotation, honors `INBRAIN_AUDIT_DIR` via the shared `resolveAuditDir()`
 ...
 * `tail -F ~/.inbrain/audit/lock-renewal-*.jsonl`.
 */
