 ...
 * outcome at `~/.inbrain/audit/self-upgrade-YYYY-Www.jsonl` (honors
 * INBRAIN_AUDIT_DIR). Built on the shared `audit-writer` primitive. Read back by
 * `inbrain doctor`'s `self_upgrade_health` check. Best-effort: never throws.
 *
