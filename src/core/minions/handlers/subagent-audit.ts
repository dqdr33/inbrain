 ...
 *                 `inbrain agent logs <job> --follow` has fresh content to
 ...
 *
 * `INBRAIN_AUDIT_DIR` overrides the default ~/.inbrain/audit/ path — useful
 ...
 * files. Used by `inbrain agent logs <job>`. Returns chronological order.
 *
