 ...
 *   - match the `InbrainConfig` field-name convention
 */
 ...
 * inbrain-flavored names we use a inbrain-prefixed form so they don't collide
 * with provider conventions: `database_url` becomes `INBRAIN_DATABASE_URL`
