...
export interface LockRenewalKnobs {
   ...
   * Env: `INBRAIN_LOCK_RENEWAL_MAX_FAILURES`. Default: 3.
   */
  maxFailuresForAudit: number;
  /**
   * Per-renewLock-call timeout enforced via `Promise.race`.
   * Env: `INBRAIN_LOCK_RENEWAL_CALL_TIMEOUT_MS`. Default: `lockDuration / 3`.
   ...
   * Env: `INBRAIN_LOCK_RENEWAL_SAFETY_MARGIN_MS`. Default: `lockDuration / 6`.
   */
 ...
 * operator who sets `INBRAIN_LOCK_RENEWAL_CALL_TIMEOUT_MS=abc` gets a
...
export function resolveLockRenewalKnobs(
  ...
  return {
    maxFailuresForAudit: parsePositiveInt(
      env.INBRAIN_LOCK_RENEWAL_MAX_FAILURES,
      defaultMaxFailures,
      'INBRAIN_LOCK_RENEWAL_MAX_FAILURES',
    ),
    callTimeoutMs: parsePositiveInt(
      env.INBRAIN_LOCK_RENEWAL_CALL_TIMEOUT_MS,
      defaultCallTimeout,
      'INBRAIN_LOCK_RENEWAL_CALL_TIMEOUT_MS',
    ),
    safetyMarginMs: parsePositiveInt(
      env.INBRAIN_LOCK_RENEWAL_SAFETY_MARGIN_MS,
      defaultSafetyMargin,
      'INBRAIN_LOCK_RENEWAL_SAFETY_MARGIN_MS',
    ),
  };
}
