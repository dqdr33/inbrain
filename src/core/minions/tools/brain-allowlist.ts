 ...
 * knows brain tools write to the inbrain DB (NOT local files) and to reach
...
export const BRAIN_TOOL_USAGE_HINTS: Readonly<Record<string, string>> = {
  ...
  put_page: 'Write a markdown page to the inbrain DATABASE (NOT the local filesystem). Page becomes searchable + linkable. Slug must match the agent\'s allowed namespace.',
...
export interface BuildBrainToolsOpts {
  ...
  /**
   * Connected-inbrains brain id (v0.19+, PR 0 plumbing only).
   *
