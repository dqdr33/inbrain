 ...
 * (`'You are a helpful assistant running as a inbrain subagent.'`) and gave
...
export const DEFAULT_SUBAGENT_SYSTEM =
  'You are a helpful assistant running as a inbrain subagent.';
 ...
 *   Brain tools (`put_page`, `search`, `query`) write to the inbrain database,
 *   not to local files.
 *
