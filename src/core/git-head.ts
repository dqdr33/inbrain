/**
 * v0.41.27.0 — git HEAD freshness probe for `inbrain doctor`.
 *
 ...
 * working tree to be clean — mirroring `inbrain sync`'s force-walk gate at
...
export interface GitFreshnessOpts {
   ...
   *     v0.41.27.0 posture mirroring `inbrain sync`'s gate at sync.ts:1075.
 ...
 * is clean.
 *
 * This is NOT a full mirror of `inbrain sync`'s "do work?" predicate.
