 ...
 *
 * `schema_version: 1` is the wire contract for `inbrain eval suspected-contradictions --json`.
 ...
 *
 * - temporal_supersede     → render `inbrain takes supersede ... --since <date>`
 ...
 * rollup so operators can see whether `inbrain eval suspected-contradictions`
