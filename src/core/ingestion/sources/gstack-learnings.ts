/**
 * GStackLearningsSource — bridge gstack's JSONL learnings into inbrain.
 *
 ...
 * investigation). The data never makes it into inbrain today — engineers
 ...
 * inbrain-engineer pack manifest). The daemon routes to put_page,
 ...
 *     files; inbrain only reads).
 *
 * Pack-active gating: this source is only registered with the daemon
 * when the active pack is inbrain-engineer (or inbrain-everything which
