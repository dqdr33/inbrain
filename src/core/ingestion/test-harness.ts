 ...
 *
 * Exported as a public subpath (inbrain/ingestion/test-harness) and pinned by
 ...
 * Typical usage:
 *
 *   import { IngestionTestHarness, expectEvent } from 'inbrain/ingestion/test-harness';
 ...
 * `inbrain ingest test --watch` is for (CLI-side ephemeral brain for the
