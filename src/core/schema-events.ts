// v0.39 T15 — inbrain schema CLI event audit.
//
// JSONL at ~/.inbrain/audit/schema-events-YYYY-Www.jsonl. ISO-week rotation
...
// NEVER throws.
//
// Feeds T23's `inbrain schema usage --since 30d` for the experimental-tier
 ...
 * `inbrain schema usage --since 30d`. Walks recent ISO-week files
