 ...
 * 2. `inbrain doctor` — runtime health check with actionable agent guidance
 ...
 *
 *   Format 1 (table) — original inbrain shape:
...
export function checkResolvable(skillsDir: string): ResolvableReport {
  ...
  // `inbrain skillify scaffold`. Presence means a scaffolded skill
