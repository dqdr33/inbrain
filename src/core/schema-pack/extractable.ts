...
// `extractable: true`. inbrain-base preserves the 7 legacy types so
...
// to use the hardcoded ELIGIBLE_TYPES list — which inbrain-base also
 ...
 * `ExtractableSpec`.
 *
 * Consumed by `inbrain extract benchmark`, `inbrain extract --explain`,
 * and `inbrain schema scaffold-extractable`.
 */
