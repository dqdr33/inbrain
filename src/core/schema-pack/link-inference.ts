...
// in inbrain-base.yaml literally would require multi-line YAML escape
// jujitsu and lose the in-source comments documenting WHY each pattern
// is shaped the way it is.
//
// Pragmatic split: inbrain-base.yaml carries verb NAMES + simplified
...
//      inbrain-base's production-quality matching of founded /
...
// them deliberately; legacy fall-through covers the inbrain-base
// universe.
