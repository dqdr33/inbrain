/**
 * v0.42 Wave C1 — `inbrain schema scaffold-extractable` mutation primitive.
 *
 ...
 *      etc.) so the pack-author can run `inbrain extract benchmark` immediately
 ...
 * Each line is one JSON-serialized fixture per the `inbrain extract
...
export async function scaffoldExtractable(
  ...
  // is the canonical inbrain scaffold posture (matches schema init,
