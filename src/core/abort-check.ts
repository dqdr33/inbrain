 ...
 *
 * inbrain has several long-running loops (embed --stale, embed --all, dream
 ...
 * to completion ignoring the abort, so `inbrain_cycle_locks` stayed held and
 ...
 *                  ▼
 *   finally releases inbrain_cycle_locks → next cycle runs
 *
