...
/** True iff this content carries the brainstorm frontmatter marker (saved by `inbrain brainstorm --save`). */
...
/**
 * Read a single ad-hoc transcript file (`inbrain dream --input <file>`).
