 ...
 *
 * Reads `dream.auto_think.questions[]` from config, runs `inbrain think` on
 ...
 *   inbrain config set dream.auto_think.enabled true
 *   inbrain config set dream.auto_think.questions '["What patterns ...","Who ..."]'
 */
 ...
 * standalone for now and are invoked via `inbrain dream --phase auto_think`
