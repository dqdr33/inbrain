 ...
 *
 * Events land at `~/.inbrain/audit/skillopt-YYYY-Www.jsonl` (ISO-week rotated;
 * honors `INBRAIN_AUDIT_DIR`).
 *
...
/**
 * Test seam — reset the cached writer so tests with mocked INBRAIN_AUDIT_DIR
...
/** Resolve audit dir (honors INBRAIN_AUDIT_DIR). */
