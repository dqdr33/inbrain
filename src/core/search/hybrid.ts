...
const DEBUG = process.env.INBRAIN_SEARCH_DEBUG === '1';
 ...
 *
 * Why this exists: inbrain's bounded boosts (`[1.0, ~1.6]` log-compressed
...
const QUERY_EMBED_TIMEOUT_MS = (() => {
  const n = Number(process.env.INBRAIN_QUERY_EMBED_TIMEOUT_MS);
...
export async function hybridSearch(
  ...
  // is a public surface (inbrain/search/hybrid) so a third-party closure bug
