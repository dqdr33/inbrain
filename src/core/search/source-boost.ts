 ...
 *
 * Override via env: INBRAIN_SOURCE_BOOST="originals/:1.8,openclaw/chat/:0.3"
 * Hard-exclude via env: INBRAIN_SEARCH_EXCLUDE="test/,scratch/"
 */
...
/**
 * Parse INBRAIN_SOURCE_BOOST env var.
...
/**
 * Parse INBRAIN_SEARCH_EXCLUDE env var.
...
export function resolveBoostMap(
  envValue: string | undefined = process.env.INBRAIN_SOURCE_BOOST,
...
export function resolveHardExcludes(
  excludeOpt?: string[],
  includeOpt?: string[],
  envValue: string | undefined = process.env.INBRAIN_SEARCH_EXCLUDE,
): string[] {
