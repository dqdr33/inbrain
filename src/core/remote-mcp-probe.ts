 ...
 * `inbrain init --mcp-only` and the thin-client doctor both need. No SDK
 ...
 * Servers that strictly require the full handshake will reject; inbrain's
    ...
    const res = await fetch(mcpUrl, {
      ...
      body: JSON.stringify({
        ...
        params: {
          ...
          capabilities: {},
          clientInfo: { name: 'inbrain-init-smoke', version: '1' },
        },
      }),
      signal: controller.signal,
    });
