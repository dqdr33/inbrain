 ...
 *
 * Namespace:
 *   Every entry's `key` starts with 'inbrain:calibration:v0.36.1.0:' so an
...
export const GSTACK_LEARNING_NAMESPACE = 'inbrain:calibration:v0.36.1.0:';
