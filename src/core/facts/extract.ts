 ...
 * `inbrain config set facts.extraction_enabled false` to disable extraction
 ...
 * Configurable via `inbrain config set facts.extraction_model <model>`.
 */
