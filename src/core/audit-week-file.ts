 ...
 * every inbrain audit JSONL writer (shell-audit, phantom-audit,
...
/**
 * Resolve the audit directory: honors `INBRAIN_AUDIT_DIR` env override,
 * falls back to `inbrainPath('audit')`. The directory may not exist yet;
