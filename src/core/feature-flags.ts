 ...
 *
 * What the flag gates:
 *   - Parallel branch of `inbrain sync --all` (serial fallback otherwise)
 ...
 *
 * Disable path:
 *   inbrain config set sync.federated_v2 false
 *   inbrain jobs supervisor restart   # autopilot picks up the change
 *
