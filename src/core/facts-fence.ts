...
export const FACTS_FENCE_BEGIN = '<!--- inbrain:facts:begin -->';
export const FACTS_FENCE_END   = '<!--- inbrain:facts:end -->';
...
export interface ParsedFact {
   ...
   *   - `forgotten` true: the user invoked `inbrain forget` on this row;
   ...
   * `inbrain eval trajectory` + the `find_trajectory` MCP op chronological
