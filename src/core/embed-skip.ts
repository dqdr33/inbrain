 ...
 *   inbrain has 5 sites that filter the stale-chunk / all-pages query
 *   for embedding:
 *
 ...
 *
 *   Inline-filtering across 5 sites is the exact bug class inbrain has
 ...
 *  for callers that walk pages JS-side (e.g. `inbrain embed --all`
