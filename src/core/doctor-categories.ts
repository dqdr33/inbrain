 ...
 *             fallback audit, schema-pack drift. The "is inbrain itself
 *             coherent?" question.
 *
...
/**
 * inbrain-itself coherence signals. Schema migrations, version drift, audit
 ...
 * `inbrain doctor --scope=brain` sub-second on a brain with thousands of
