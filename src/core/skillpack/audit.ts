 ...
 * ISO-week-rotated JSONL at `~/.inbrain/audit/skillpack-YYYY-Www.jsonl`.
 *
 ...
 *
 * `inbrain doctor`'s skillpack_activity check reads the last 7 days to
...
/** Resolve the audit directory; honors INBRAIN_AUDIT_DIR. */
...
/** Read recent events. Used by `inbrain doctor` for the activity surface. */
