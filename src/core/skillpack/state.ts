...
export const SKILLPACK_STATE_SCHEMA_VERSION = 'inbrain-skillpack-state-v1' as const;
...
export function defaultStatePath(): string {
  return inbrainPath('skillpack-state.json');
}
 ...
 * the directory exists (inbrainPath returns paths under ~/.inbrain which
 * setup-inbrain ensures, but we mkdir defensively).
 */
