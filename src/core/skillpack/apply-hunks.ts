 ...
 *
 * Used by `inbrain skillpack reference --apply-clean-hunks`. For each
 * hunk in a diff between inbrain's bundle and the user's local file,
 ...
 *
 * Two-way diff against inbrain's CURRENT bundle (no scaffold-time base
 ...
 *
 * No system `patch(1)` dependency — portable to every inbrain target.
 */
