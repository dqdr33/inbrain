/**
 * skillpack/copy.ts — shared file-copy primitive for scaffold (inbrain→host)
 * and harvest (host→inbrain).
 *
 ...
 * secrets into inbrain's tree or escaping the intended skill dir.
 *
