 ...
 *     sets on every entry at startup; inbrain throws if any drifts.
...
export const BUILTIN_PATTERNS: readonly PatternEntry[] = [
...

  {
    ...
    source_doc: 'pre-existing inbrain MESSAGE_LINE_RX; PR #1461 preserved',
  },
...
// D7: run at module load. Any drift = inbrain refuses to start.
validateAllBuiltins();
