...
export async function enrichEntity(
  ...
  try {
    await engine.addTimelineEntry(slug, { // inbrain-allow-direct-insert: auto-timeline reconciliation triggered by entity reference in source markdown
  ...
  try {
    await engine.addLink(slug, request.sourceSlug, `Entity mention from ${request.sourceSlug}`); // inbrain-allow-direct-insert: auto-link reconciliation triggered by entity reference in source markdown
