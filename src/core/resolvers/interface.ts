...
export interface ResolverResult<O> {
   ...
   * Callers use this to gate auto-writes (e.g., inbrain integrity --auto only
...
export interface ResolverContext {
  ...
  /** Key-value config passed through inbrain config + env. Resolvers read what they need. */
...
export interface Resolver<I, O> {
  ...
  /** Optional description for `inbrain resolvers list`. */
