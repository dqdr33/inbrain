 ...
 * inbrain's migration chain walk forward.
 *
 ...
 *
 * Usage:
 *   const dbPath = await seedPglite('/tmp/run-x/.inbrain/brain.pglite', seedSql);
 *   // Then run `inbrain init --pglite --path <dbPath>` — the migration chain
