 ...
 *
 * Each operation writes to its own JSONL file (~/.inbrain/fail-improve/{operation}.jsonl).
...
// Lazy: INBRAIN_HOME may be set after module load, so resolve at call time.
const getLogDir = () => inbrainPath('fail-improve');
