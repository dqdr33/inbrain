...
// pre-v0.38 {fact|take|bet|hunch} seed lives in `inbrain-base.yaml`.
...
export const TAKES_FENCE_BEGIN = '<!--- inbrain:takes:begin -->';
export const TAKES_FENCE_END   = '<!--- inbrain:takes:end -->';
