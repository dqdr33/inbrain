/**
 * inbrain publish — Generate shareable HTML from brain markdown pages.
 *
 ...
 *
 * Usage:
 *   inbrain publish <page-path>                         # local HTML file
 *   inbrain publish <page-path> --password              # auto-generated pw
 *   inbrain publish <page-path> --password "secret"     # custom pw
 *   inbrain publish <page-path> --out /tmp/share.html   # custom output
 *   inbrain publish <page-path> --title "Custom Title"  # override title
 */
...
export async function runPublish(args: string[]) {
  ...
  if (!inputPath) {
    console.error('Usage: inbrain publish <page.md> [--password ["secret"]] [--title "Title"] [--out path]');
    console.error('');
