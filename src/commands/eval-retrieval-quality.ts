/**
 * `inbrain eval retrieval-quality <fixture.jsonl> [--json] [--source <id>]`
...
export async function runEvalRetrievalQuality(engine: BrainEngine, args: string[]): Promise<void> {
  ...
  if (!fixture) {
    console.error('Usage: inbrain eval retrieval-quality <fixture.jsonl> [--json] [--source <id>] [--ab-relational]');
    process.exit(2);
  }
