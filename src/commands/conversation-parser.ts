/**
 * v0.41.16.0 — `inbrain conversation-parser` debug CLI.
 *
...
function printHelp(): void {
  process.stdout.write(`Usage: inbrain conversation-parser <subcommand> [options]
...
Examples:
  inbrain conversation-parser scan conversations/imessage/alice-example
  inbrain conversation-parser list-builtins --json
  inbrain conversation-parser validate ./my-pattern.json
