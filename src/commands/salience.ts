/**
 * inbrain salience — Pages recently touched, ranked by emotional + activity salience.
 *
 ...
 *
 * Usage:
 *   inbrain salience                            # top 20 over last 14 days
 *   inbrain salience --days 7                   # narrower window
 *   inbrain salience --kind personal            # filter to slug-prefix
 *   inbrain salience --json                     # JSON for agents
 */
...
const HELP = `Usage: inbrain salience [options]
