  ...
  try {
    ...
    if (v < 51) {
      return {
        name: 'schema',
        status: 'failed',
        detail: `expected schema version >= 51 (facts_fence_columns); got ${v}. Run \`inbrain apply-migrations --yes\` to apply.`,
      };
    }
...
export const v0_32_2: Migration = {
  ...
  featurePitch: {
    ...
    description:
      ...
      'migration. `inbrain rebuild` (v0.32.3) becomes a one-line disaster-recovery flow because ' +
