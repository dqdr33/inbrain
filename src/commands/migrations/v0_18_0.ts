 ...
 *   A. Schema — inbrain init --migrate-only runs the migration chain up
...
export const v0_18_0: Migration = {
  ...
  featurePitch: {
    ...
    description:
      'v0.18.0 introduces sources — a first-class primitive that lets one inbrain backend hold ' +
      ...
      'brain. New commands: `inbrain sources add/attach/import-from-github`. Per-directory ' +
      'default via .inbrain-source dotfile + INBRAIN_SOURCE env var. See docs/guides/' +
