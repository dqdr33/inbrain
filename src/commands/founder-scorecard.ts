/**
 * inbrain founder scorecard <entity-slug> — rolls up Phase 2's typed-claim
 ...
 *
 * Usage:
 *   inbrain founder scorecard companies/acme-example
 *   inbrain founder scorecard companies/acme-example --since 2025-05-17 --until 2026-05-17
 *   inbrain founder scorecard companies/acme-example --json
 */
...
const HELP = `Usage: inbrain founder scorecard <entity-slug> [options]
...
Examples:
  inbrain founder scorecard companies/acme-example
  inbrain founder scorecard companies/acme-example --since 2025-05-17 --json
`;
