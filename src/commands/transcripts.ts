/**
 * inbrain transcripts — Recent raw conversation transcripts.
 *
 ...
 *
 * Usage:
 *   inbrain transcripts recent              # last 7 days, summaries
 *   inbrain transcripts recent --days 14
 *   inbrain transcripts recent --full       # full content (capped at 100KB/file)
 *   inbrain transcripts recent --json
 */
...
const HELP = `Usage: inbrain transcripts recent [options]
