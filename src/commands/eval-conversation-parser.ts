/**
 * v0.41.16.0 — `inbrain eval conversation-parser <fixture.jsonl>` CLI verb.
 *
...
function parseArgs(args: string[]): CliArgs {
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    if (a === '--fixtures') {
      ...
      // Positional fixture path (e.g. `inbrain eval conversation-parser path.jsonl`).
      out.fixtures = a;
    }
  }
  return out;
...
function printHelp(): void {
  process.stdout.write(`Usage: inbrain eval conversation-parser [options] <fixture.jsonl>
