/**
 * inbrain anomalies — Statistical anomalies in recent page activity.
 *
 ...
 *
 * Usage:
 *   inbrain anomalies                          # since=today, lookback=30d, sigma=3
 *   inbrain anomalies --since 2026-04-28
 *   inbrain anomalies --sigma 2 --lookback-days 60
 *   inbrain anomalies --json
 */
...
const HELP = `Usage: inbrain anomalies [options]
