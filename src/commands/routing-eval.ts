/**
 * inbrain routing-eval — Standalone CLI verb for Check 5 (W2).
 *
...
const HELP = `inbrain routing-eval [options]
...
export async function runRoutingEvalCli(args: string[]): Promise<void> {
  ...
  // doctor said "fine" but `inbrain routing-eval --strict` still failed.
