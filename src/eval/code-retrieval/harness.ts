 ...
 *
 * Two modes:
 *   --baseline       Uses only `query` + `search` (today's inbrain). The number
 ...
 * --help mode. Real runs connect to ~/.inbrain (the dogfood brain) by default
...
// ─────────────────────────────────────────────────────────────────
// Types — stable contract for downstream consumers (inbrain-evals, CI)
// ─────────────────────────────────────────────────────────────────
...
export interface CodeQuestion {
   ...
   * are intentionally low (0.3) since today's inbrain can't answer them.
   */
