...
export const DEFAULT_GATE: GateOpts = {
  hardFamilies: {
    'title-substring': { hit_at_1: floorEnv('INBRAIN_NTB_TITLE_HIT1', 0.95) },
    'multi-chunk-dilution': { hit_at_3: floorEnv('INBRAIN_NTB_DILUTION_HIT3', 1.0) },
    'alias-synonym': { hit_at_1: floorEnv('INBRAIN_NTB_ALIAS_HIT1', 0.98) },
  },
