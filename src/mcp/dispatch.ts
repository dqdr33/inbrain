...
export interface DispatchOpts {
  /** Defaults to true (remote/untrusted). Local CLI callers (`inbrain call`) pass false. */
  remote?: boolean;
   ...
   * INBRAIN_SOURCE / .inbrain-source / 'default'; HTTP MCP transport
 ...
 * `inbrain serve --http`; that path bypasses this helper and writes the raw
