...
- Raw source preserved for provenance via `inbrain files upload-raw`
...
2. **Upload raw source.** Save the fetched content for provenance: `inbrain files upload-raw <file> --page <slug>`
...
6. **Sync.** `inbrain sync` to update the index.
