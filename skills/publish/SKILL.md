...
how to use it. See [Thin Harness, Fat Skills](https://x.com/inbrain-ai/status/2042925773300908103)
...
- **Assuming the user wants raw markdown.** The publish command produces beautiful HTML. Don't copy-paste markdown when `inbrain publish` exists.
...
- `inbrain publish` -- deterministic HTML generation (no LLM calls)
- `inbrain files upload` -- upload to cloud storage (optional)
- `inbrain files signed-url` -- generate access links (optional)
