...
1. `inbrain search "name"` — keyword search for existing pages
2. `inbrain query "natural question about name"` — hybrid search for context
3. `inbrain get <slug>` — if you know the slug, read the full page
