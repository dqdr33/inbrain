...
For EACH attendee:
1. `inbrain search "{name}"` — does a people page exist?
...
4. Add timeline entry on the person's page:
   `inbrain timeline-add <person-slug> <date> "Attended <meeting-title>"`

**Note (v0.10.1):** Once the meeting page is written via `inbrain put`, the
...
`inbrain sync` to update the index.
