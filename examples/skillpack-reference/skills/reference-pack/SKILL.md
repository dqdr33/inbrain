...
This is the canonical reference for a third-party inbrain skillpack. Read
its tree once and you know how to author one.

## What this skill does

When the user asks how third-party inbrain skillpacks work, this skill
...
- `runbooks/bootstrap.md` — agent-readable post-scaffold steps. inbrain
...
Run `inbrain skillpack doctor <pack-dir>` to see exactly which
