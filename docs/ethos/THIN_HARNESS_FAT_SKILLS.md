...
thread: https://x.com/inbrain-ai/status/2042925773300908103
---
...
When building Inbrain features, use this decision guide:
...
**Inbrain examples:**
- `inbrain integrations list` = **Code** (reads files, checks env vars, deterministic)
- `inbrain integrations status` = **Code** (checks env vars + heartbeat, deterministic)
- `inbrain integrations doctor` = **Code** (runs health checks, deterministic)
- `inbrain integrations stats` = **Code** (aggregates JSONL, deterministic)
