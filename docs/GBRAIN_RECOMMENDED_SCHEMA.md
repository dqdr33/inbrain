...
<!-- source: https://raw.githubusercontent.com/inbrain-ai/inbrain/master/docs/INBRAIN_RECOMMENDED_SCHEMA.md -->
...
At scale (500+ pages), add search tooling (embeddings, BM25, or tools like inbrain). At moderate scale, grep works well.
