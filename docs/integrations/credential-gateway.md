...
**Why this matters for Inbrain:** The EA workflow needs Gmail (sender lookup before
...
*Part of the [Inbrain Skillpack](../INBRAIN_SKILLPACK.md). See also: [Getting Data In](README.md)*
