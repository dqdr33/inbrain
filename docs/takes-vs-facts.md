...
inbrain has two epistemological storage layers that serve different purposes.
**Never conflate them.**
...
**Query surface:** `inbrain takes list`, `inbrain takes search`, `inbrain think`
...
**Query surface:** `inbrain recall`, MCP `_meta.brain_hot_memory`
